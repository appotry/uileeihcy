...
#define BUTTON_BKGND_RENDER_STATE_SELECTED_NORMAL   4
#define BUTTON_BKGND_RENDER_STATE_SELECTED_HOVER    5
#define BUTTON_BKGND_RENDER_STATE_SELECTED_PRESS    6
#define BUTTON_BKGND_RENDER_STATE_SELECTED_DISABLE  7
...
#define MENU_ITEM_RADIOCHECKED_RENDER_STATE_NORMAL   0
#define MENU_ITEM_RADIOCHECKED_RENDER_STATE_HOVER    1
#define MENU_ITEM_RADIOCHECKED_RENDER_STATE_PRESS    2
#define MENU_ITEM_RADIOCHECKED_RENDER_STATE_DISABLE  3
...
#define MENU_POPUPTRIANGLE_RENDER_STATE_DISABLE 3
