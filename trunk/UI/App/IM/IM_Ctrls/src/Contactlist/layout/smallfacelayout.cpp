#include "stdafx.h"
#include "SmallfaceLayout.h"
#include "App\IM\IM_Ctrls\inc\icontactlist.h"

void  SmallfaceLayout::Release()
{
    delete this;
}

void SmallfaceLayout::Arrange(UI::IListItemBase* pStartToArrange, SIZE* pSizeContent)
{
    CRect  rcClient;
    CRect  rcItem;
...
void  SmallfaceLayout::Measure(SIZE* pSize)
{
    pSize->cx = pSize->cy = 0;
...
int  SmallfaceLayout::GetItemHeight(UI::IListItemBase*  pItem)
{
