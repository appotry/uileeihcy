...
class CChangeSkinDlg : public UI::ICustomWindow
{
public:
    CChangeSkinDlg();
    ~CChangeSkinDlg();

    UI_BEGIN_MSG_MAP_Ixxx(CChangeSkinDlg)
...
protected:
    ...
    void  ChangeSkin(const String&  strImageFile, int nImageDrawType, int nBkgndColor, int nHLSColor);
