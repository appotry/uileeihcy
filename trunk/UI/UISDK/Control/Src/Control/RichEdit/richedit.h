...
public:
    // 接口转发
    LONG  GetSelBarWidth() { return m_wrapRichEidt.GetSelBarWidth(); }
    LONG  SetSelBarWidth(LONG l_SelBarWidth) { return m_wrapRichEidt.SetSelBarWidth(l_SelBarWidth); }
    bool  GetRichTextFlag() { return m_wrapRichEidt.GetRichTextFlag(); }
    void  SetRichTextFlag(bool b) { m_wrapRichEidt.SetRichTextFlag(b); }
    bool  SetText(const TCHAR* szText) { return m_wrapRichEidt.SetText(szText); }
